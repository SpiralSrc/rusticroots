...
export default function page() {
  return (
    <div className="w-screen pt-24">
      <div className="max-w-7xl mx-2 xs:mx-auto flex flex-col items-center justify-center mb-20 pb-20 backdrop-blur-sm rounded-xl border border-orange-400/30 px-10 lg:px-0">
